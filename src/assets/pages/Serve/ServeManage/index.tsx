    ...
    return (
        <>
            <div className="top-search" style={{marginBottom: 24}}>
                <Button type="primary" onClick={() => setIsModalOpen(true)}>新增服务分类</Button>
            </div>
            <ConfigProvider
                theme={{
                    token: {
            ...
            >
                ...
                <Modal title="新增服务分类" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                    <Input/>
                </Modal>
            </ConfigProvider>
        </>
